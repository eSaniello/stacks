...
--
-- Host: localhost
-- Gegenereerd op: 30 jul 2019 om 04:30
...
INSERT INTO `freelancers` (`freelancer_id`, `type_id`, `gebruikersnaam`, `naam`, `voornaam`, `email`, `mobiel`, `adres`, `woonplaats`, `opleiding`, `werkervaring`, `wachtwoord`, `status`) VALUES
...
(3, 2, 'eSaniello', 'Samadhan', 'Shaniel', 'shanielsamadhan@gmail.com', 8855412, 'weedstraat 69', 'Paramaribo', '$2y$10$sgKkTN3UPkUCh3HPI9prJe0vKxf..zVmvtRjGZfTuBhwcT43nrHtm'),
(4, 2, 'skuut', 'Sylvio', 'Jo', 'josylvio@gmail.com', 8989553, 'skittleweg 420', 'welgelegen', '$2y$10$BPL15ojheB.7SDFMV9y7G.KJNE04.x9w4OaF9ZP8tCDaZ.J/1W8aK');
